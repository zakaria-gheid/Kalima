...
- 2300 seeded English–Arabic noun cards (1000 easy / 1000 medium / 300 hard) across 21 categories
...
The vocabulary database is seeded from `assets/data/words_seed.txt`, a pipe-delimited file (`english|arabic|category|difficulty`) containing exactly 2300 words — 1000 easy, 1000 medium, 300 hard — across 21 categories. The database syncs from this file on every start: words missing from the database are imported, existing rows are left untouched. To add words, edit the file and restart.
